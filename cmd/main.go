...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "e737867b.leryn.io",
	...
	if err = (&controller.CsNodeDaemonReconciler{
		Client:       mgr.GetClient(),
		OriginScheme: mgr.GetScheme(),
		Config: &config.OperatorConfig{
			ManagedNamespace: "sre-base",
		},
	}).SetupWithManager(mgr); err != nil {
		setupLog.Error(err, "unable to create controller", "controller", "CsNodeDaemon")
		os.Exit(1)
	}
